...
struct MultiMatchAnyImpl
{
        ...
        [[maybe_unused]] std::optional<UInt32> edit_distance)
    {
        ...
        {
            MatchImpl<Name, MatchSyntax::Re2, NegateMatch::No, MatchCaseInsensitively::No>::vectorConstant(haystack_data, haystack_offsets, needles[j].toString(), nullptr, accum);
